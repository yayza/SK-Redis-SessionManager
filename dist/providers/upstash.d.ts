import type { upstashRedisSessionOptions } from '../shared.js';
import type { Cookies } from '@sveltejs/kit';
export declare class upstashSessionStore {
    ...
    constructor({ redisClient, secret, cookieName, sessionPrefix, userSessionsPrefix, signed, useTTL, renewSessionBeforeExpire, renewBeforeSeconds, serializer, cookiesOptions }: upstashRedisSessionOptions);
