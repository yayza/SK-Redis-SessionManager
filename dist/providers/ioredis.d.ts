import type { ioRedisSessionOptions } from '../shared.js';
import type { Cookies } from '@sveltejs/kit';
export declare class IoRedisSessionStore {
    ...
    constructor({ redisClient, secret, cookieName, sessionPrefix, userSessionsPrefix, signed, useTTL, renewSessionBeforeExpire, renewBeforeSeconds, serializer, cookiesOptions }: ioRedisSessionOptions);
